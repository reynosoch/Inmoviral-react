...
namespace Inmoviral3._0
{
    public partial class frmComprar : Form
    {
        ...
        public frmComprar() { InitializeComponent(); ConfigurarInicio(); }
        public frmComprar(Usuarios usuario) { InitializeComponent(); this.usuarioLogueado = usuario; ConfigurarInicio(); }
        ...
        // --- CARGAR TARJETAS (CON LÓGICA ADMIN) ---
        private void CargarTarjetas()
        {
            ...
            foreach (DataRow fila in tablaCasas.Rows)
            {
                ...
                if (esAdmin)
                {
                    ...
                    {
                        DialogResult r = MessageBox.Show("¿Eres Admin. Deseas eliminar esta publicación?", "ADMINISTRADOR", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
                        if (r == DialogResult.Yes)
                        {
                            modelo.EliminarPublicacion(id);
                            CargarTarjetas(); // Recargar la lista para que desaparezca
                        }
                    };
                }
                // ----------------------------------
                ...
                // Aseguramos que el clic funcione en los hijos, EXCEPTO en los botones de acción
        ...
        private void label4_Click(object sender, EventArgs e) { frmRentar rentar = new frmRentar(this.usuarioLogueado); rentar.Show(); this.Close(); }
        ...
        private void btnlogin_Click(object sender, EventArgs e) { frmLogin login = new frmLogin(); login.Origen = "Comprar"; login.Show(); this.Close(); }
        ...
        {
            if (comboboxComprar != null) { comboboxComprar.Items.Clear(); comboboxComprar.Items.Add("Comprar"); comboboxComprar.Items.Add("Rentar"); comboboxComprar.SelectedIndex = 0; }
