...
const resources = {
  es: {
    translation: {
      "nav_1": "Inicio", "nav_2": "Nosotros", "nav_3": "Catálogo", "nav_4": "Servicios Virales", "nav_btn": "Agendar Cita",
      ...
      "ticker_1": "Trato Directo Sin Intermediarios", "ticker_2": "Limpieza Profunda Incluida", "ticker_3": "Fotografía Profesional de Alto Impacto",
      "ticker_4": "Logística de Mudanza Completa", "ticker_5": "Exposición Masiva en Redes", "ticker_6": "Soporte Técnico 24/7",
      "ticker_7": "Campañas de Marketing Viral", "ticker_8": "Atención Personalizada", "ticker_9": "Sin Proveedores Externos",
      "ticker_10": "Garantía de Satisfacción Total", "ticker_11": "Asesoría Legal Integral", "ticker_12": "Tranquilidad Garantizada",
      
      "f1_title_1": "Limpieza", "f1_title_2": "Profunda", "f1_desc": "Dejamos el inmueble impecable y reluciente antes de cada visita o entrega final para garantizar el mejor impacto visual.",
      "f2_title_1": "Fotografía", "f2_title_2": "Profesional", "f2_desc": "Sesiones multimedia de alta calidad y contenido optimizado para redes sociales que hacen destacar tu propiedad.",
      "f3_title_1": "Logística de", "f3_title_2": "Mudanza", "f3_desc": "Coordinamos todo el traslado de tus pertenencias con cuidado y precisión para que no pases por nada de estrés.",
      "f4_title_1": "Exposición", "f4_title_2": "Constante", "f4_desc": "Estrategias de marketing masivo para conectar de manera rápida y efectiva a compradores con vendedores.",
      
      "gal_label": "Nuestro Catálogo", "gal_title_1": "Propiedades que", "gal_title_2": "se convierten en el centro", "gal_title_3": "de tu vida", "gal_view_all": "EXPLORAR PORTAFOLIO →",
      "g_t1": "San Felipe", "g_t2": "Cordilleras", "g_t3": "Zona Centro", "g_t4": "Las Águilas", "g_t5": "Residencial", "g_t6": "Contemporánea", "g_t7": "Minimalista", "g_t8": "Vista Panorámica",
      
      "about_label": "Sobre InmoViral", "about_title_1": "Conectamos", "about_title_2": "hogares con", "about_title_3": "estrategias virales",
      ...
      "p1_tag": "Venta · Inversión", "p1_title_1": "Encuentra tu", "p1_title_2": "próximo hogar", "p1_desc": "Explora casas listas para habitar que ya cuentan con los beneficios de limpieza profunda e inspección de calidad antes de tu visita de cortesía.", "p1_btn": "Agendar asesoría →",
      "p2_tag": "Promoción · Rapidez", "p2_title_1": "Vende con", "p2_title_2": "Servicios Virales", "p2_desc": "Hacemos que tu propiedad destaque en el mercado con sesiones de foto profesionales y campaigns digitales masivas diseñadas para atraer compradores rápido.", "p2_btn": "Registrar propiedad →",
  ...
  en: {
    translation: {
      ...
      "hero_title_2": "Discerning Clients",
...
i18n
  ...
  .init({
    resources,
    lng: "es", // Lo dejé en español por defecto para que no veas los textos en crudo al recargar, pero puedes cambiarlo a "en"
    fallbackLng: "es",
    interpolation: {
      escapeValue: false
    }
